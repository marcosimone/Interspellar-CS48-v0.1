...
def options():
	...
	while 1:
		...
		screen.blit(setting, (200,54)) 
		screen.blit(music_label, (190,165))
		screen.blit(music_toggle, (385, 150))
		
		screen.blit(kb_ins, (850,150))
		screen.blit(m_ins, (900,350))
		screen.blit(instr, (750,50))
		y += 1
		if y == 1440:
			y = 0
		...
		if Rect(100, 575, back.get_width(), back.get_height()).collidepoint(pygame.mouse.get_pos()):
			...
			back = back_idle
	#music toggle hover mechanics
		if Rect(385,150, 105, 70).collidepoint(pygame.mouse.get_pos()) and music_toggle == music_toggle_on:
			music_toggle = music_toggle_on_hover
		elif not(Rect(385,150, 105, 70).collidepoint(pygame.mouse.get_pos())) and music_toggle == music_toggle_on_hover:
			music_toggle = music_toggle_on
		elif Rect(385,150, 105, 70).collidepoint(pygame.mouse.get_pos()) and music_toggle == music_toggle_off:
			music_toggle = music_toggle_off_hover
		elif not(Rect(385,150, 105, 70).collidepoint(pygame.mouse.get_pos())) and music_toggle == music_toggle_off_hover:
			music_toggle = music_toggle_off
		...
		for event in pygame.event.get():
			if event.type == QUIT:
				sys.exit()
			if event.type == MOUSEBUTTONUP and event.button == 1:			
	#music toggle click mechanics
				if Rect(385,150, 105, 70).collidepoint(event.pos):
					if music_toggle == music_toggle_on_hover:
						music_toggle = music_toggle_off_hover
						pygame.mixer.music.stop()
						sounds.click.play()
						
					elif music_toggle == music_toggle_off_hover:
						music_toggle = music_toggle_on_hover
						pygame.mixer.music.play(-1)
						sounds.click.play()
